          ...
          ?>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="box grid recipes">
                            ...
                            <h2>
                                <a class="showinfo" data-channelid="<?php echo $channeldata[$i]['id']; ?>" data-title="<?php echo $channeldata[$i]['title']; ?>" target="_blank" href="https://www.youtube.com/channel/<?php echo $channeldata[$i]['id']; ?>">
