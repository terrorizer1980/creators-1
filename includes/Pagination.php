...
class Pagination{
    ...
    protected $fullTagOpen  = '<nav aria-label="Page navigation example"><ul class="pagination justify-content-center">';
    protected $fullTagClose = '</ul></nav>';
    protected $firstTagOpen = '';
    protected $firstTagClose= '';
    protected $lastTagOpen  = '';
    protected $lastTagClose = '';
    protected $curTagOpen   = '<li class="page-item active"><span class="page-link">';
    ...
    function createLinks(){ 
        ...
        if($this->currentPage != 1){
            $i = ($uriPageNum - 1);
            if($i == 0) $i = '';
            $output .= $this->prevTagOpen.'<li class="page-item"><a class="page-link" href="'.$this->baseURL.$i.'">'.$this->prevLink.'</a></li>'.$this->prevTagClose;
        }
        ...
        if($this->currentPage < $numPages){
            ...
            $output .= $this->nextTagOpen.'<li class="page-item"><a class="page-link" href="'.$this->baseURL.$i.'">'.$this->nextLink.'</a></li>'.$this->nextTagClose;
        }
