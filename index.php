...
$pagConfig = array(
    'baseURL'=>'http://localhost/creators/index.php',
    'totalRows'=>$rowCount,
    'perPage'=>$limit
);
        ...
        <div class="list">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php }else{ ?>
                        <h5>
                            <?php echo number_format(mysqli_num_rows($run)); ?> creators found </h5>
                        <?php } ?>
                ...
                foreach($response->items as $item){
                    ...
                    $channeldata[$i]['subscribers'] = $item->statistics->subscriberCount;
          ...
          ?>
              ...
              <img src="https://discoverbrands.co/public/img/loader.gif" data-src="<?php echo $channeldata[$i]['image'] ?>" alt="">
                            ...
                            <p>
                                <a title="Country" class="details" style="color:#e13b2b" href="#!">
                                    <?php echo $channeldata[$i]['country'] ?>
                                </a>
                            </p>

                            <p><span class="details" title='<p><span style="text-decoration:underline">Channel Title:</span><br><?php echo filteredDesc($channeldata[$i]['title']);  ?></p><p><span style="text-decoration:underline">Description:</span><br><?php echo filteredDesc($channeldata[$i]['description']); ?></p><p><span style="text-decoration:underline">Keywords:</span><br><?php echo filteredDesc($channeldata[$i]['keywords']); ?></p>'><i class="fa fa-info-circle" style="color:#e13b2b;cursor:pointer"></i> More</span> - <span class="details" title="Total Videos Count"><i class="fa fa-video" style="color:#e13b2b"></i> <b><?php echo $channeldata[$i]['videos']; ?></b></span></p>
                            <br>
                        </div>
                    </div>
                    <?php 
